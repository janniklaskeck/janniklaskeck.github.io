...
I chose to implement this as an exercise, since the core game design is already "done".
This allowed me to implement it over the course of a little more than a month.
